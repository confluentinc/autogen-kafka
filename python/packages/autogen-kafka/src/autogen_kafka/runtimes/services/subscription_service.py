...
class SubscriptionService(StreamingWorkerBase[KafkaAgentRuntimeConfig]):
    """
    ...
    def __init__(self,
        ...
        Args:
            config (KafkaAgentRuntimeConfig): Configuration for the worker including subscription topic settings
